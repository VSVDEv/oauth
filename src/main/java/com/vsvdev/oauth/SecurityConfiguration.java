...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
  ...
  public GrantedAuthoritiesMapper grantedAuthoritiesMapper() {
    ...
    var issuer = "https://vsvdev.auth0.com/";
  ...
  public ClientRegistrationRepository clientRegistrationRepository() {
    return new InMemoryClientRegistrationRepository(
        ClientRegistration.withRegistrationId("my-app")
            ...
            .authorizationUri("https://vsvdev.auth0.com/authorize")
            .tokenUri("https://vsvdev.auth0.com/oauth/token")
            .jwkSetUri("https://vsvdev.auth0.com/.well-known/jwks.json")
            .userInfoUri("https://vsvdev.auth0.com/userinfo")
